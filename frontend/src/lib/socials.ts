import { Facebook, Globe, Instagram, Music2, Twitter, Youtube, type LucideIcon } from "lucide-react";
...
export interface SocialDef {
  key: "instagram" | "tiktok" | "youtube" | "facebook" | "x" | "website";
  code: string;
  label: string;
  icon: LucideIcon;
  placeholder: string;
...
export const SOCIALS: SocialDef[] = [
  ...
  { key: "x", code: "X", label: "X (Twitter)", icon: Twitter, placeholder: "https://x.com/yourbrand" },
